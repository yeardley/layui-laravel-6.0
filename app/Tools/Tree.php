<?php
/**
 * FileName: App\Tools\Tree
 * Author: yeardley
 * Email: 510865496@qq.com
 * Since: 2020/5/23 17:57
 * Describe:
 */
...
class Tree
{
     ...
     * @return array
     */
    public static function arr2tree($list, $id = 'id', $pid = 'parent_id', $son = 'sub')
    {
        if ($list instanceof Collection) $list = $list->toArray();
        list($tree, $map) = [[], []];
     ...
     * @return array
     */
    public static function arr2table($list, $id = 'id', $pid = 'parent_id', $path = 'path', $ppath = '')
    {
        $tree = [];
        if ($list instanceof Collection) $list = $list->toArray();
     ...
     * @return array
     */
    public static function getArrSubIds($list, $id = 0, $key = 'id', $pkey = 'parent_id')
    {
